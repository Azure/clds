...
TEST_FUNCTION(clds_hash_table_insert_inserts_one_key_value_pair)
{
    ...
    STRICT_EXPECTED_CALL(clds_singly_linked_list_node_create(IGNORED_NUM_ARG))
        .CaptureReturn(&linked_list_item);
    STRICT_EXPECTED_CALL(clds_singly_linked_list_insert(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
...
TEST_FUNCTION(clds_hash_table_insert_with_NULL_hash_table_fails)
{
    ...
    // act
    result = clds_hash_table_insert(NULL, hazard_pointers_thread, (void*)0x1, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
...
TEST_FUNCTION(clds_hash_table_insert_with_NULL_clds_hazard_pointers_thread_fails)
{
    ...
    // act
    result = clds_hash_table_insert(hash_table, NULL, (void*)0x1, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
...
TEST_FUNCTION(clds_hash_table_insert_with_NULL_key_fails)
{
    ...
    // act
    result = clds_hash_table_insert(hash_table, hazard_pointers_thread, NULL, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
...
TEST_FUNCTION(when_creating_the_singly_linked_list_fails_clds_hash_table_insert_fails)
{
    ...
    // act
    result = clds_hash_table_insert(hash_table, hazard_pointers_thread, (void*)0x1, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
...
TEST_FUNCTION(clds_hash_table_insert_with_2nd_key_on_the_same_bucket_does_not_create_another_list)
{
    ...
    int result;
    hash_table = clds_hash_table_create(test_compute_hash, 2, hazard_pointers);
    (void)clds_hash_table_insert(hash_table, hazard_pointers_thread, (void*)0x1, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
    umock_c_reset_all_calls();
    ...
    // act
    result = clds_hash_table_insert(hash_table, hazard_pointers_thread, (void*)0x2, (void*)0x4242, test_item_cleanup_func, (void*)0x4242);
...
TEST_FUNCTION(clds_hash_table_insert_with_item_cleanup_callback_NULL_succeeds)
{
    ...
    // act
    result = clds_hash_table_insert(hash_table, hazard_pointers_thread, (void*)0x1, (void*)0x4242, NULL, (void*)0x4242);
...
/* Tests_SRS_CLDS_HASH_TABLE_01_024: [ If a bucket is identified and the delete of the item from the underlying list fails, `clds_hash_table_delete` shall fail and return a non-zero value. ]*/
