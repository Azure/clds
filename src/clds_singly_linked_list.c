...
static CLDS_SINGLY_LINKED_LIST_DELETE_RESULT internal_delete(CLDS_SINGLY_LINKED_LIST_HANDLE clds_singly_linked_list, CLDS_HAZARD_POINTERS_THREAD_HANDLE clds_hazard_pointers_thread, SINGLY_LINKED_LIST_ITEM_COMPARE_CB item_compare_callback, void* item_compare_callback_context)
{
    ...
    do
    {
        ...
        do
        {
            ...
            volatile CLDS_SINGLY_LINKED_LIST_ITEM* current_item = interlocked_compare_exchange_pointer((void* volatile*)current_item_address, NULL, NULL);
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (interlocked_compare_exchange_pointer((void* volatile*)current_item_address, (void*)current_item, (void*)current_item) != (void*)((uintptr_t)current_item & ~0x1))
                    {
                        if (previous_hp != NULL)
                        {
                            // let go of previous hazard pointer
                    ...
                    else
                    {
                        ...
                        if (item_compare_callback(item_compare_callback_context, (CLDS_SINGLY_LINKED_LIST_ITEM*)current_item))
                        {
                            ...
                            volatile CLDS_SINGLY_LINKED_LIST_ITEM* current_next = interlocked_compare_exchange_pointer((void* volatile*)&current_item->next, NULL, NULL);

                            // mark that the node is deleted
                            if (interlocked_compare_exchange_pointer((void* volatile*)&current_item->next, (void*)((uintptr_t)current_next | 1), (void*)((uintptr_t)current_next & (~0x1))) != (void*)((uintptr_t)current_next & (~0x1)))
                            {
                                if (previous_hp != NULL)
                                {
                                    // let go of previous hazard pointer
                            ...
                            else
                            {
                                ...
                                if (previous_item == NULL)
                                {
                                    ...
                                    if (interlocked_compare_exchange_pointer((void* volatile*)&clds_singly_linked_list->head, (void*)current_next, (void*)current_item) != (void*)current_item)
                                    {
                                        // head changed, restart
                                        (void)interlocked_compare_exchange_pointer((void* volatile*)&current_item->next, (void*)current_next, (void*)((uintptr_t)current_next | 1));
                                ...
                                {
                                    if (interlocked_compare_exchange_pointer((void* volatile*)&previous_item->next, (void*)current_next, (void*)current_item) != (void*)current_item)
                                    {
...
CLDS_SINGLY_LINKED_LIST_HANDLE clds_singly_linked_list_create(CLDS_HAZARD_POINTERS_HANDLE clds_hazard_pointers)
{
    ...
    else
    {
        ...
        else
        {
            ...
            (void)interlocked_exchange_pointer((void* volatile*)&clds_singly_linked_list->head, NULL);
        }
    }
...
void clds_singly_linked_list_destroy(CLDS_SINGLY_LINKED_LIST_HANDLE clds_singly_linked_list)
{
    ...
    {
        CLDS_SINGLY_LINKED_LIST_ITEM* current_item = interlocked_compare_exchange_pointer((void* volatile*)&clds_singly_linked_list->head, NULL, NULL);
        ...
        {
            CLDS_SINGLY_LINKED_LIST_ITEM* next_item = interlocked_compare_exchange_pointer((void* volatile*)&current_item->next, NULL, NULL);
...
int clds_singly_linked_list_insert(CLDS_SINGLY_LINKED_LIST_HANDLE clds_singly_linked_list, CLDS_HAZARD_POINTERS_THREAD_HANDLE clds_hazard_pointers_thread, CLDS_SINGLY_LINKED_LIST_ITEM* item)
{
    ...
    else
    {
        ...
        do
        {
            ...
            item->next = (CLDS_SINGLY_LINKED_LIST_ITEM*)interlocked_compare_exchange_pointer((void* volatile*)&clds_singly_linked_list->head, NULL, NULL);

            if (interlocked_compare_exchange_pointer((void* volatile*)&clds_singly_linked_list->head, item, (void*)item->next) != item->next)
            {
                restart_needed = true;
            }
            else
...
CLDS_SINGLY_LINKED_LIST_ITEM* clds_singly_linked_list_find(CLDS_SINGLY_LINKED_LIST_HANDLE clds_singly_linked_list, CLDS_HAZARD_POINTERS_THREAD_HANDLE clds_hazard_pointers_thread, SINGLY_LINKED_LIST_ITEM_COMPARE_CB item_compare_callback, void* item_compare_callback_context)
{
    ...
    else
    {
        ...
        do
        {
            ...
            {
                // get the current_item value
                volatile CLDS_SINGLY_LINKED_LIST_ITEM* current_item = (volatile CLDS_SINGLY_LINKED_LIST_ITEM*)interlocked_compare_exchange_pointer((void* volatile*)current_item_address, NULL, NULL);
...
CLDS_SINGLY_LINKED_LIST_ITEM* clds_singly_linked_list_node_create(size_t node_size, SINGLY_LINKED_LIST_ITEM_CLEANUP_CB item_cleanup_callback, void* item_cleanup_callback_context)
{
    ...
    else
    {
        ...
        (void)interlocked_exchange_pointer((void* volatile*)&item->next, NULL);
    }
